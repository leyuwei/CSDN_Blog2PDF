...
def main():
	...
	text1 = tk.Label(root, text="输入爬取网址：", font=ft_title, justify='left', anchor='w')
	...
	text2 = Label(root, text="若为爬取整个博客，输入格式为：https://blog.csdn.net/jacksparrow\n若为爬取特定博文，格式为：https://blog.csdn.net/jacksparrow/article/details/12345678", font=ft_hint, justify='left', anchor='w')
